...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="flexbox1">
                <input type="radio" id="NHS" name="serviceType" value="NHS" checked form="signupform">
                <label for="NHS">NHS</label><br>
                <input type="radio" id="private" name="serviceType" value="Private" form="signupform">
                <label for="private">Private</label><br>
            </div>
            <div class="flexbox1">
                    <button class="buttonBlueStyle" type="submit" value="SignUp" form="signupform">Signup</button>
            </div>
